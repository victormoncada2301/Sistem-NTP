    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('almacen/articulo')}}" class="logo">
          ...
          <span class="logo-mini"><b>NT</b>P</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>New Times</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('almacen/articulo')}}"><i class="fa fa-circle-o"></i> Entradas</a></li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Eventos</h3>
